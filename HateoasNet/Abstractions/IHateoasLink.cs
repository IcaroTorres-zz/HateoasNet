...
namespace HateoasNet.Abstractions
{
	...
	public interface IHateoasLink
	{
		...
		/// <summary>
		/// Gets a <see cref="IDictionary{TKey, TValue}"/> of <see cref="string" />,
		/// <see cref="object" /> representing the route values.
		/// </summary>
		...
		/// </param>
		/// <returns>
		/// Generated route values dictionary <see cref="IDictionary{TKey, TValue}"/> of <see cref="string"/>,
		/// <see cref="object"/>.
		/// </returns>
	...
	{
		/// <summary>
		/// A framework function to generate <see cref="IDictionary{TKey, TValue}"/> of <see cref="string" />,
		/// <see cref="object" /> representing the route values.
		/// </summary>
		...
		/// <summary>
		/// Receives an user defined function returning anonymous <see cref="object"/> for ease usage, converting it to
		/// <see cref="RouteDictionaryFunction"/> internally.
		/// </summary>
		/// <param name="routeDataFunction">Function returning anonymous <see cref="object"/> for ease usage.</param>
		/// <returns>Current <see cref="IHateoasLink{T}"/> instance.</returns>
		IHateoasLink<T> HasRouteData(Func<T, object> routeDataFunction);

		/// <summary>Receives an user defined predicate function to filter applicability of <see cref="IHateoasLink{T}"/></summary>
